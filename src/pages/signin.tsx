...
import { ILoginData, login as loginUser } from '../api/auth';
...
export default function Signin() {
  ...
  const [isEmailVerified, setEmailVerified] = React.useState<boolean | undefined>();
      ...
      >
        ...
        >
          ...
          >
            ...
            <When condition={isEmailVerified}>
              <Flex my="4" py="4" px="2" flexDir="column" textAlign="center" bgColor="green.100" rounded="lg">
                <Text>{t('congratulations-you-have-verified-your-account')}</Text>
                <Text>{t('please-login-to-enjoy-full-experience')}</Text>
              </Flex>
            </When>
            <form
              style={{ width: '100%' }}
